...
-- CreateEnum
CREATE TYPE "public"."AccessRole" AS ENUM ('MEMBER', 'IC', 'ADMIN');

-- CreateEnum
CREATE TYPE "public"."SessionType" AS ENUM ('TRAINING', 'EVENT', 'SAFETY_REFRESHER');

-- CreateEnum
CREATE TYPE "public"."YearOfStudy" AS ENUM ('YEAR_1', 'YEAR_2', 'YEAR_3', 'YEAR_4', 'ALUMNI', 'GRADUATE');
...
CREATE TABLE "public"."User" (
    ...
    "blockedUntil" DATE,
    "createdAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "accessRole" "public"."AccessRole" NOT NULL DEFAULT 'MEMBER',
...
CREATE TABLE "public"."Session" (
    ...
    "lanes" INTEGER[],
    "name" TEXT NOT NULL,
    "sessionType" "public"."SessionType" NOT NULL DEFAULT 'TRAINING',
...
-- CreateTable
CREATE TABLE "public"."AttendanceFile" (
    "id" UUID NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "TrainingPlan_sessionId_key" ON "public"."TrainingPlan"("sessionId");
...
-- AddForeignKey
ALTER TABLE "public"."User" ADD CONSTRAINT "user_id_fk" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "public"."TrainingPlan" ADD CONSTRAINT "TrainingPlan_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "public"."Session"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Signup" ADD CONSTRAINT "Signup_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "public"."Session"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."SessionIC" ADD CONSTRAINT "SessionIC_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "public"."Session"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."SessionIC" ADD CONSTRAINT "SessionIC_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
